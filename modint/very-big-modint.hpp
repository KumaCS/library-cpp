...
// mod (2^127-1)
struct VeryBigModInt {
  using mint = VeryBigModInt;
 ...
 public:
  ...
  VeryBigModInt() : _v(0) {}
  VeryBigModInt(int v) : _v(v < 0 ? M + v : v) {}
  VeryBigModInt(long long v) : _v(v < 0 ? M + v : v) {}
  VeryBigModInt(unsigned long long v) : _v(v) {}
  VeryBigModInt(u128 v) : _v(calc_mod(v)) {}
