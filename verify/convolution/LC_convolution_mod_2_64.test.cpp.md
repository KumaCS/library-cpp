...
data:
  ...
  bundledCode: "#line 1 \"verify/convolution/LC_convolution_mod_2_64.test.cpp\"\n\
    ...
    \ isqrt(long long n) {\n  if (n <= 0) return 0;\n  long long x = sqrt(n);\n  while\
    \ ((x + 1) * (x + 1) <= n) x++;\n  while (x * x > n) x--;\n  return x;\n}\nlong\
    \ long floor_root(long long n, int k) {\n  assert(n >= 0);\n  if (n == 0) return\
    \ 0;\n  assert(k >= 1);\n  if (k == 1) return n;\n  if (k > 64) return 1;\n  long\
    \ long x = round(pow((long double)n, 1.0L / k));\n  auto check = [&](long long\
    \ a) {\n    if (a <= 0) return true;\n    __int128_t p = 1;\n    for (int i =\
    ...
    \  }\n  return c;\n}\n};  // namespace ConvolutionMod2_64\n\n/**\n * @brief \u7573\
    \u307F\u8FBC\u307F mod 2^64\n */\n#line 5 \"verify/convolution/LC_convolution_mod_2_64.test.cpp\"\
    \n\nint main() {\n  int n, m;\n  in(n, m);\n  vector<ull> a(n), b(m);\n  in(a,\
  ...
  verifiedWith: []
documentation_of: verify/convolution/LC_convolution_mod_2_64.test.cpp
layout: document
redirect_from:
- /verify/verify/convolution/LC_convolution_mod_2_64.test.cpp
- /verify/verify/convolution/LC_convolution_mod_2_64.test.cpp.html
