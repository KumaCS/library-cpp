...
data:
  ...
  bundledCode: "#line 1 \"verify/matrix/LC_matrix_det.test.cpp\"\n#define PROBLEM\
    ...
    #line 5 \"verify/matrix/LC_matrix_det.test.cpp\"\nusing mint = ModInt<998244353>;\n\
    ...
    \ j = 0; j < mat.w; j++) {\n        os << mat.get(i, j);\n        if (j + 1 <\
    \ mat.w) os << \" \";\n      }\n      if (i + 1 < mat.h) os << \"\\n\";\n    }\n\
    \    return os;\n  }\n};\n#line 7 \"verify/matrix/LC_matrix_det.test.cpp\"\n\n\
    int main() {\n  int n;\n  in(n);\n  Matrix<mint> a(n);\n  rep(i, 0, n) rep(j,\
    \ 0, n) {\n    mint x;\n    in(x);\n    a.set(i, j, x);\n  }\n  out(a.det());\n\
    }\n"
  ...
  verifiedWith: []
documentation_of: verify/matrix/LC_matrix_det.test.cpp
layout: document
redirect_from:
- /verify/verify/matrix/LC_matrix_det.test.cpp
- /verify/verify/matrix/LC_matrix_det.test.cpp.html
