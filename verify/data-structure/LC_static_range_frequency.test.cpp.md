...
data:
  ...
  bundledCode: "#line 1 \"verify/data-structure/LC_static_range_frequency.test.cpp\"\
    ...
    \ = int32_t;\n  using u32 = uint32_t;\n  using u64 = uint64_t;\n\n  static constexpr\
    \ u32 W = 64;\n  inline u32 get(u32 i) const { return u32(block[i / W] >> (i %\
    ...
    \ */\n#line 5 \"verify/data-structure/LC_static_range_frequency.test.cpp\"\n\n\
    int main() {\n  int n, q;\n  in(n, q);\n  vector<int> a(n);\n  in(a);\n  WaveletMatrix<int,\
    \ 30> wm(a);\n  while (q--) {\n    int l, r, x;\n    in(l, r, x);\n    out(wm.range_freq(l,\
    \ r, x, x + 1, 0));\n  }\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/data-structure/LC_static_range_frequency.test.cpp
layout: document
redirect_from:
- /verify/verify/data-structure/LC_static_range_frequency.test.cpp
- /verify/verify/data-structure/LC_static_range_frequency.test.cpp.html
