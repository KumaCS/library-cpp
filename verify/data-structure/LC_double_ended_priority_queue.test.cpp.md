...
data:
  ...
  bundledCode: "#line 1 \"verify/data-structure/LC_double_ended_priority_queue.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/data-structure/LC_double_ended_priority_queue.test.cpp
layout: document
redirect_from:
- /verify/verify/data-structure/LC_double_ended_priority_queue.test.cpp
- /verify/verify/data-structure/LC_double_ended_priority_queue.test.cpp.html
