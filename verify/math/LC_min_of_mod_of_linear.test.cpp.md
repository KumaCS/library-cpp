...
data:
  ...
  bundledCode: "#line 1 \"verify/math/LC_min_of_mod_of_linear.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/min_of_mod_of_linear\"\n\n#line 2\
    ...
    \ */\n#line 5 \"verify/math/LC_min_of_mod_of_linear.test.cpp\"\n\nint main() {\n\
    \  int t;\n  in(t);\n  while (t--) {\n    ll n, m, a, b;\n    in(n, m, a, b);\n\
  ...
  verifiedWith: []
documentation_of: verify/math/LC_min_of_mod_of_linear.test.cpp
layout: document
redirect_from:
- /verify/verify/math/LC_min_of_mod_of_linear.test.cpp
- /verify/verify/math/LC_min_of_mod_of_linear.test.cpp.html
