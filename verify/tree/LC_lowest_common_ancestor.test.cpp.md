...
data:
  ...
  bundledCode: "#line 1 \"verify/tree/LC_lowest_common_ancestor.test.cpp\"\n#define\
    ...
    \ Ancestor\n * @docs docs/tree/lowest-common-ancestor.md\n */\n#line 5 \"verify/tree/LC_lowest_common_ancestor.test.cpp\"\
    \n\nint main() {\n  int n, q;\n  in(n, q);\n  auto g = IO::Tree::rooted(n, true,\
  ...
  verifiedWith: []
documentation_of: verify/tree/LC_lowest_common_ancestor.test.cpp
layout: document
redirect_from:
- /verify/verify/tree/LC_lowest_common_ancestor.test.cpp
- /verify/verify/tree/LC_lowest_common_ancestor.test.cpp.html
