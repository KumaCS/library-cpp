...
data:
  ...
  bundledCode: "#line 1 \"verify/set/LC_bitwise_xor_convolution.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/bitwise_xor_convolution\"\n\n#line\
    ...
    \ is_prime = Math::is_prime<m>;\n};\n#line 5 \"verify/set/LC_bitwise_xor_convolution.test.cpp\"\
    \nusing mint = ModInt<998244353>;\n#line 2 \"set/xor-convolution.hpp\"\n\n#line\
    \ 2 \"set/hadamard-transform.hpp\"\n\ntemplate <class T>\nvoid HadamardTransform(vector<T>&\
    \ f, bool inv = false) {\n  int n = f.size();\n  assert((n & (n - 1)) == 0);\n\
    \  for (int i = 1; i < n; i <<= 1) {\n    for (int j = 0; j < n; j++) {\n    \
    \  if ((j & i) == 0) {\n        T x = f[j], y = f[j | i];\n        f[j] = x +\
...
layout: document
redirect_from:
- /verify/verify/set/LC_bitwise_xor_convolution.test.cpp
- /verify/verify/set/LC_bitwise_xor_convolution.test.cpp.html
