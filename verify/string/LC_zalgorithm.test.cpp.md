...
data:
  ...
  bundledCode: "#line 1 \"verify/string/LC_zalgorithm.test.cpp\"\n#define PROBLEM\
    ...
    #line 5 \"verify/string/LC_zalgorithm.test.cpp\"\n\nint main() {\n  string s;\n\
    \  in(s);\n  out(ZAlgorithm(s));\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/string/LC_zalgorithm.test.cpp
layout: document
redirect_from:
- /verify/verify/string/LC_zalgorithm.test.cpp
- /verify/verify/string/LC_zalgorithm.test.cpp.html
