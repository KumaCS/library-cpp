...
data:
  ...
  bundledCode: "#line 1 \"verify/algorithm/LC_cartesian_tree.test.cpp\"\n#define PROBLEM\
    ...
    \ \";\n  _show(i + 1, a, c...);\n}\n#line 2 \"algorithm/cartesian-tree.hpp\"\n\
    ...
    \ nodes[nodes[i][0] = st[top - 1]][2]) = i;\n      st[top] = i;\n    } else {\n\
    \      nodes[nodes[i][0] = st[top]][2] = i;\n      st[++top] = i;\n    }\n  }\n\
    \  return {root, nodes};\n}\n#line 5 \"verify/algorithm/LC_cartesian_tree.test.cpp\"\
    \n\nint main() {\n  int n;\n  in(n);\n  vector<int> a(n);\n  in(a);\n  auto [root,\
    \ nodes] = CartesianTree(a);\n  vector<int> p(n);\n  rep(i, 0, n) p[i] = nodes[i][0]\
    \ == -1 ? i : nodes[i][0];\n  out(p);\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/algorithm/LC_cartesian_tree.test.cpp
layout: document
redirect_from:
- /verify/verify/algorithm/LC_cartesian_tree.test.cpp
- /verify/verify/algorithm/LC_cartesian_tree.test.cpp.html
