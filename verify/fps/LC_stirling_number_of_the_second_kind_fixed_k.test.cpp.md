...
data:
  ...
  bundledCode: "#line 1 \"verify/fps/LC_stirling_number_of_the_second_kind_fixed_k.test.cpp\"\
    ...
    };\n#line 5 \"verify/fps/LC_stirling_number_of_the_second_kind_fixed_k.test.cpp\"\
    ...
    \ 1)).pre(i << 1);\n  return ret.pre(deg);\n}\n#line 7 \"verify/fps/LC_stirling_number_of_the_second_kind_fixed_k.test.cpp\"\
    ...
    \ */\n#line 9 \"verify/fps/LC_stirling_number_of_the_second_kind_fixed_k.test.cpp\"\
    \n\nint main() {\n  int n, k;\n  in(n, k);\n  out(SecondKindStirlingNumbersFixedK<mint>(n,\
    \ k));\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/fps/LC_stirling_number_of_the_second_kind_fixed_k.test.cpp
layout: document
redirect_from:
- /verify/verify/fps/LC_stirling_number_of_the_second_kind_fixed_k.test.cpp
- /verify/verify/fps/LC_stirling_number_of_the_second_kind_fixed_k.test.cpp.html
