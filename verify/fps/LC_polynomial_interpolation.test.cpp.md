...
data:
  ...
  bundledCode: "#line 1 \"verify/fps/LC_polynomial_interpolation.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/polynomial_interpolation\"\n\n#line\
    ...
    \ is_prime = Math::is_prime<m>;\n};\n#line 5 \"verify/fps/LC_polynomial_interpolation.test.cpp\"\
    ...
    \ 1)).pre(i << 1);\n  return ret.pre(deg);\n}\n#line 7 \"verify/fps/LC_polynomial_interpolation.test.cpp\"\
    ...
    \ */\n#line 9 \"verify/fps/LC_polynomial_interpolation.test.cpp\"\n\nint main()\
    \ {\n  int n;\n  in(n);\n  vector<mint> x(n), y(n);\n  in(x, y);\n  out(PolynomialInterpolation(x,\
    \ y));\n}\n"
...
layout: document
redirect_from:
- /verify/verify/fps/LC_polynomial_interpolation.test.cpp
- /verify/verify/fps/LC_polynomial_interpolation.test.cpp.html
