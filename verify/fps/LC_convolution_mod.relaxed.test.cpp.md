...
data:
  ...
  bundledCode: "#line 1 \"verify/fps/LC_convolution_mod.relaxed.test.cpp\"\n#define\
    ...
    };\n#line 5 \"verify/fps/LC_convolution_mod.relaxed.test.cpp\"\nusing mint = ModInt<998244353>;\n\
    ...
    \ 1)).pre(i << 1);\n  return ret.pre(deg);\n}\n#line 7 \"verify/fps/LC_convolution_mod.relaxed.test.cpp\"\
    ...
    \ */\n#line 9 \"verify/fps/LC_convolution_mod.relaxed.test.cpp\"\n\nint main()\
    \ {\n  int n, m;\n  in(n, m);\n  fps a(n), b(m);\n  in(a, b);\n  fps c(n + m -\
    \ 1);\n  RelaxedMultiply<mint> conv;\n  rep(i, 0, n + m - 1) c[i] = conv.append(i\
    \ < n ? a[i] : 0, i < m ? b[i] : 0);\n  out(c);\n}\n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/convolution_mod\"\n\n#include\
    ...
    \ a(n), b(m);\n  in(a, b);\n  fps c(n + m - 1);\n  RelaxedMultiply<mint> conv;\n\
    \  rep(i, 0, n + m - 1) c[i] = conv.append(i < n ? a[i] : 0, i < m ? b[i] : 0);\n\
    \  out(c);\n}"
  dependsOn:
  - template/template.hpp
  - template/macro.hpp
  ...
  verifiedWith: []
documentation_of: verify/fps/LC_convolution_mod.relaxed.test.cpp
layout: document
redirect_from:
- /verify/verify/fps/LC_convolution_mod.relaxed.test.cpp
- /verify/verify/fps/LC_convolution_mod.relaxed.test.cpp.html
