...
data:
  ...
  bundledCode: "#line 1 \"verify/fps/LC_sharp_p_subset_sum.test.cpp\"\n#define PROBLEM\
    ...
    \ is_prime = Math::is_prime<m>;\n};\n#line 5 \"verify/fps/LC_sharp_p_subset_sum.test.cpp\"\
    ...
    \ 1)).pre(i << 1);\n  return ret.pre(deg);\n}\n#line 7 \"verify/fps/LC_sharp_p_subset_sum.test.cpp\"\
    ...
    \ c[i];\n    for (int j = 1; i * j <= n; j++) {\n      f[i * j] += s * fact::inv(j);\n\
    \      s = -s;\n    }\n  }\n  return f.exp();\n}\n/**\n * @brief Count Subset\
    \ Sum\n * @docs docs/fps/count-subset-sum.md\n */\n#line 9 \"verify/fps/LC_sharp_p_subset_sum.test.cpp\"\
    \n\nint main() {\n  int n, t;\n  in(n, t);\n  vector<int> a(n);\n  in(a);\n  auto\
    \ b = CountSubsetSum<mint>(a, t);\n  b.erase(b.begin());\n  out(b);\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/fps/LC_sharp_p_subset_sum.test.cpp
layout: document
redirect_from:
- /verify/verify/fps/LC_sharp_p_subset_sum.test.cpp
- /verify/verify/fps/LC_sharp_p_subset_sum.test.cpp.html
