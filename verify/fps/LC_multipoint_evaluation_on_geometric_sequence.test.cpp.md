...
data:
  ...
  bundledCode: "#line 1 \"verify/fps/LC_multipoint_evaluation_on_geometric_sequence.test.cpp\"\
    ...
    \ is_prime = Math::is_prime<m>;\n};\n#line 5 \"verify/fps/LC_multipoint_evaluation_on_geometric_sequence.test.cpp\"\
    ...
    \ 1)).pre(i << 1);\n  return ret.pre(deg);\n}\n#line 7 \"verify/fps/LC_multipoint_evaluation_on_geometric_sequence.test.cpp\"\
    ...
    \ f[i] *= irs[i];\n  return f;\n}\n\n/**\n * @brief \u591A\u70B9\u8A55\u4FA1\n\
    \ * @docs docs/fps/multipoint-evaluation.md\n */\n#line 9 \"verify/fps/LC_multipoint_evaluation_on_geometric_sequence.test.cpp\"\
    \n\nint main() {\n  int n, m;\n  mint a, r;\n  in(n, m, a, r);\n  fps c(n);\n\
  ...
  verifiedWith: []
documentation_of: verify/fps/LC_multipoint_evaluation_on_geometric_sequence.test.cpp
layout: document
redirect_from:
- /verify/verify/fps/LC_multipoint_evaluation_on_geometric_sequence.test.cpp
- /verify/verify/fps/LC_multipoint_evaluation_on_geometric_sequence.test.cpp.html
