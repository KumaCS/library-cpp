...
data:
  ...
  bundledCode: "#line 1 \"verify/fps/LC_composition_of_formal_power_series_large.test.cpp\"\
    ...
    \ is_prime = Math::is_prime<m>;\n};\n#line 5 \"verify/fps/LC_composition_of_formal_power_series_large.test.cpp\"\
    ...
    \ 1)).pre(i << 1);\n  return ret.pre(deg);\n}\n#line 7 \"verify/fps/LC_composition_of_formal_power_series_large.test.cpp\"\
    ...
    #line 9 \"verify/fps/LC_composition_of_formal_power_series_large.test.cpp\"\n\n\
    int main() {\n  int n;\n  in(n);\n  fps f(n), g(n);\n  in(f, g);\n  fps h = Composition(f,\
    \ g);\n  out(h);\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/fps/LC_composition_of_formal_power_series_large.test.cpp
layout: document
redirect_from:
- /verify/verify/fps/LC_composition_of_formal_power_series_large.test.cpp
- /verify/verify/fps/LC_composition_of_formal_power_series_large.test.cpp.html
