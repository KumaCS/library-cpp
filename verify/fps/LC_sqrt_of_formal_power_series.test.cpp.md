...
data:
  ...
  bundledCode: "#line 1 \"verify/fps/LC_sqrt_of_formal_power_series.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/sqrt_of_formal_power_series\"\n\n\
    ...
    \ is_prime = Math::is_prime<m>;\n};\n#line 5 \"verify/fps/LC_sqrt_of_formal_power_series.test.cpp\"\
    ...
    \ 1)).pre(i << 1);\n  return ret.pre(deg);\n}\n#line 7 \"verify/fps/LC_sqrt_of_formal_power_series.test.cpp\"\
    ...
    \ << 1)) * inv2;\n  }\n  return ret.pre(deg);\n}\n#line 9 \"verify/fps/LC_sqrt_of_formal_power_series.test.cpp\"\
    \n\nint main() {\n  int n;\n  in(n);\n  fps a(n);\n  in(a);\n  a = FpsSqrt(a);\n\
    \  if (a.empty())\n    out(-1);\n  else\n    out(a);\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/fps/LC_sqrt_of_formal_power_series.test.cpp
layout: document
redirect_from:
- /verify/verify/fps/LC_sqrt_of_formal_power_series.test.cpp
- /verify/verify/fps/LC_sqrt_of_formal_power_series.test.cpp.html
