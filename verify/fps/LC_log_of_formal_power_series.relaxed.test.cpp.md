...
data:
  ...
  bundledCode: "#line 1 \"verify/fps/LC_log_of_formal_power_series.relaxed.test.cpp\"\
    ...
    };\n#line 5 \"verify/fps/LC_log_of_formal_power_series.relaxed.test.cpp\"\nusing\
    ...
    \ 1)).pre(i << 1);\n  return ret.pre(deg);\n}\n#line 7 \"verify/fps/LC_log_of_formal_power_series.relaxed.test.cpp\"\
    ...
    \ int B = 6;\n  using fps = FormalPowerSeries<mint>;\n  int n, m0;\n  fps f, g,\
    \ h;\n  vector<fps> g0;\n\n public:\n  SemiRelaxedMultiply(const fps& g_) : n(0),\
    ...
    \ */\n#line 9 \"verify/fps/LC_log_of_formal_power_series.relaxed.test.cpp\"\n\n\
    int main() {\n  int n;\n  in(n);\n  fps a(n);\n  in(a);\n  RelaxedLog<mint> log;\n\
  ...
  verifiedWith: []
documentation_of: verify/fps/LC_log_of_formal_power_series.relaxed.test.cpp
layout: document
redirect_from:
- /verify/verify/fps/LC_log_of_formal_power_series.relaxed.test.cpp
- /verify/verify/fps/LC_log_of_formal_power_series.relaxed.test.cpp.html
